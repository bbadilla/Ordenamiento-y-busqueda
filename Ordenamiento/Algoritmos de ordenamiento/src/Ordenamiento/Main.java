...
public class Main {
	...
	public static void main(String[] args) {
		...
		Integer[] arr6 = {100,5,6,87,4,1,2000,4};
		...
		Lista<String> lis4 = new Lista<>();
		lis4.insertarUltimo("kaka");
		lis4.insertarUltimo("juan");
		lis4.insertarUltimo("adasala");
		lis4.insertarUltimo("perro");
		lis4.insertarUltimo("ahala");
		lis4.insertarUltimo("caca");
		
		Lista<Integer> lis5 = new Lista<>();
		lis5.insertarUltimo(2);
		lis5.insertarUltimo(96);
		lis5.insertarUltimo(1);
		lis5.insertarUltimo(5);
		lis5.insertarUltimo(41);
		lis5.insertarUltimo(100);
		...
		D.shellLinked(lis3.primero, lis3);
		lis3.mostrar();
		...
		G.radixArrayList(lista6);
	
        System.out.print(lista6);
        System.out.print(", ");
